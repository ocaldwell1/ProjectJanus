...
public class NewTaskFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        dueDateEditText.setMinDate(System.currentTimeMillis());
    ...
    /*public void createShareableJsonLink(View view ) {
        ...
        Uri taskData = Uri.parse("http://www.janus.com/task/").buildUpon()
                ...
                .appendPath(source)
                .appendPath("" + weight)
                .appendPath("" + (dueDateEditText.getMonth() + 1))
                .appendPath("" + dueDateEditText.getDayOfMonth())
                .appendPath("" + dueDateEditText.getYear())
    ...
    /**
     * [wmenkus] (4/10/2023) This is the second half of the awful app link implementation mentioned
     * in StartFragment.
     * @param bundle the bundle of Strings that represent the task data to be filled in.
     */
    public void fillFields(Bundle bundle) {
        taskNameEditText.setText(bundle.getString("NAME"));
        sourceEditText.setText(bundle.getString("SOURCE"));
        weightSpinner.setSelection(Integer.parseInt(bundle.getString("WEIGHT")) - 1);
        int year = Integer.parseInt(bundle.getString("YEAR"));
        int month = Integer.parseInt(bundle.getString("MONTH")) - 1;
        int day = Integer.parseInt(bundle.getString("DAY"));
        dueDateEditText.updateDate(year, month, day);
        if(bundle.containsKey("NOTES")) {
            notesEditText.setText(bundle.getString("NOTES"));
        }
    }
