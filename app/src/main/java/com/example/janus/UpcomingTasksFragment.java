...
public class UpcomingTasksFragment extends Fragment implements ItemClickListener  {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        if(User.isNotLoggedIn()){
            ...
            completedTaskButton = (Button) view.findViewById(R.id.completedTaskButton);
            ...
            addTaskButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    navController.navigate(R.id.action_taskFragment_to_newTaskFragment);
            ...
            completedTaskButton.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    navController.navigate(R.id.action_taskFragment_to_completedTasksFragment);
                }
            });
        }
    }
